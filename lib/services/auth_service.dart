...
class AuthService {
  ...
  Future<bool> checkGoogleUserRegistration() async {
    ...
    try {
      ...
      final DocumentSnapshot userSnapshot = await _firebaseFirestore.collection('users').doc(user!.uid).get();
  ...
  Future<void> adduserdetail({
    ...
    required String? fcmToken, // Tambahkan field fcmToken
  }) async {
    await _firebaseFirestore.collection('users').doc(FirebaseAuth.instance.currentUser!.uid).set(
      {
        ...
        'linkedin': linkedin,
        'whatsapp': phone,
        'fcmToken': fcmToken, // Simpan fcmToken dalam dokumen pengguna
      },
    );
  }
