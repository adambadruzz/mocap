...
import '../viewmodel/detailpengurus_viewmodel.dart';
...
class DetailPengurusView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<DetailPengurusViewModel>(
      init: DetailPengurusViewModel(member: member),
      builder: (viewModel) {
        return Scaffold(
          appBar: AppBar(
            ...
            actions: [
              FutureBuilder<bool>(
                future: viewModel.member.hasSpecialRole(),
